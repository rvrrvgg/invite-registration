...
class AdminController extends Controller {
    ...
    /**
     * Create a new invite.
     * Expects JSON body: { "validityHours": int, "maxUses": int, "circleId": string }.
     */
    public function create(int $validityHours = 24, int $maxUses = 1, string $circleId = ''): DataResponse {
        try {
            $invite = $this->inviteService->create($validityHours, $maxUses, $this->getUid(), $circleId);
